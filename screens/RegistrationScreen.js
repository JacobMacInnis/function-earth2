...
class Registration extends React.Component {
  ...
  onSubmitRegistration(values) {
    console.log(values)
    const {username, password, firstName, location} = values;
    const user = {username, password, firstName, location};
  ...
  render() {
    ...
    if (this.props.registrationLoading) {
      ...
      // Registration = this.props.registrationError.message;
      console.log('error', this.props.registrationError.message)
    }
    return (
